...
class Calc(QWidget):
    ...
    def initUI(self):
        ...
        btn_1.setGeometry(40, 300, 40, 40)
        btn_2.setGeometry(120, 300, 40, 40)
        btn_3.setGeometry(200, 300, 40, 40)
        btn_4.setGeometry(40, 380, 40, 40)
        btn_5.setGeometry(120, 380, 40, 40)
        btn_6.setGeometry(200, 380, 40, 40)
        btn_7.setGeometry(40, 460, 40, 40)
        btn_8.setGeometry(120, 460, 40, 40)
        btn_9.setGeometry(200, 460, 40, 40)
        btn_0.setGeometry(120, 540, 40, 40)
        btn_plus.setGeometry(300, 300, 40, 40)
        btn_minus.setGeometry(300, 380, 40, 40)
        btn_multi.setGeometry(300, 460, 40, 40)
        btn_div.setGeometry(300, 540, 40, 40)
        btn_equal.setGeometry(400, 300, 80, 280)
        btn_clear.setGeometry(200, 540, 40, 40)
        btn_point.setGeometry(40, 540, 40, 40)

        self.calc_screen.setGeometry(40, 40, 520, 50)
        self.calc_screen.setFont(QFont('Arial', 16))
        self.resize(500, 600)
        self.center()
        self.setWindowTitle('rekmrekbnjh')
        self.show()
